...
# ==============================
RUN apt-get update &&     apt-get install -y wget gnupg ca-certificates fonts-liberation     libasound2 libatk1.0-0 libatk-bridge2.0-0 libatspi2.0-0 libcups2     libxcomposite1 libxdamage1 libxrandr2 libxkbcommon0 libxshmfence1     libgbm1 libnss3 libxss1 libdrm2 libxkbfile1 libgtk-3-0 xvfb &&     rm -rf /var/lib/apt/lists/*
